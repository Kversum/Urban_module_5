...
class House:
    def __init__(self, name, number_of_floors):
        ...
        self.number_of_floors = number_of_floors    # Кол-во этажей в объекте
    ...
    def __str__(self):
        info = f"Название объекта:{self.name}, в здании: {self.number_of_floors} {cases(len(obj_1))}"
        return info

    def __eq__(self, other):
        if isinstance(other, House):
            if self.number_of_floors == other.number_of_floors:
                print('В объектах равное ко-во этажей')
            else:
                print('В объектах не равное ко-во этажей')
...
obj_1 == obj_2          # __eq__
obj_1 = obj_1 + 10      # __add__
print(f'Сложение этажей на 10 стало:{obj_1}')
print(obj_1)
print(obj_2)
obj_1 == obj_2
print(f'Добавили в объекты {obj_1.name} и {obj_2.name} по 10 этажей ')
obj_1 += 10             # __iadd__
print(obj_1)
